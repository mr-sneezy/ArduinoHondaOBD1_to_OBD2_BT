...
//           DebugPrintln(dlcdata[2]);      //Serial monitor debug
  ...
  //Custom PID for Oil Pressure Sensor (external 0-150psi analogue 0.5-4.5V)
    ...
    float oilPSI = (oilPress - 110) / 5.2666; //oil pressure sensor scalling. Sensor range is 500mV to 4500mV for 0 - 150PSI. 5.2666 steps/PSI and offset of 110 A/D steps.
...
void Debug_oil_pressure()
{
  ...
  int oilPress = analogRead(oilPressPin); //analogRead(19);
