...
DeviceAddress Sensor1_Thermometer = { 0x28, 0xFF, 0x0C, 0x1B, 0xA3, 0x15, 0x04, 0xA5 };
DeviceAddress Sensor2_Thermometer = { 0x28, 0xFF, 0x0F, 0x4B, 0xA3, 0x15, 0x04, 0x33 };
DeviceAddress Sensor3_Thermometer = { 0x28, 0xFF, 0x75, 0x70, 0xA3, 0x15, 0x01, 0x00 };
...
if (Screen_Number == false) {  //Use Kerpz original screen
  // display
  // R0000 S000 V00.0
  // E00 I00    V00.0
  unsigned short i = 0;
...
//SNEEZY HACKING - 
if (Screen_Number == true) {  //Use SNEEZY screen No2
...
void loop() {
//SNEEZY HACKING - 
// Async type request for temps takes only 2mS, programmer must take conversion time into account (or do more useful stuff while waiting).
